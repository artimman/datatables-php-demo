...
(14, 'Test', 'test@mail.com', '$2y$10$mEUMA1kspKPQ1jLSBocmseiqqUhIfpVjmdxp1BfEVKR9S4faeOuq2', 'USER', '79816c4f2ad46e12ce55077deb68d85677233bb4', 1, '2025-04-02 10:00:42'),
(15, 'user', 'test2@mail.com', '$2y$10$AqHnlvhNdBswdBAsnfdpAuAiUgTEovAASUyfpMxjI6VRnTKWYsBPO', 'USER', 'e800270055c4ccf42d372c9e75928da2d22f037c', 1, '2025-04-02 14:00:05');
...
(13, 14, 'Artur', 'P', '600123123', 'Strona', 'test-7.png', 'Awatar, np. avatar-1.jpg', 'Firma', 'ulica'),
...
ALTER TABLE `dbm_article`
  ...
  ADD KEY `IDX_DbMArticleCategory` (`category_id`),
  ADD KEY `IDX_DbMArticleUser` (`user_id`);
...
ALTER TABLE `dbm_user_details`
  ...
  ADD KEY `IDX_DbMUserDetails` (`user_id`);
