...
namespace Dbm\DataTables\Src\Classes;

use Dbm\DataTables\Src\Classes\Http\NativeRequest;
use Dbm\DataTables\Src\Interfaces\ConfigDataTableInterface;
use Dbm\DataTables\Src\Interfaces\Http\RequestInterface;
...
class DataTableRenderer
{
    ...
    private const CELL_TEXT_LIMIT = 30;
